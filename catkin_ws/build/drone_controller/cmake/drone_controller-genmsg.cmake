...
message(STATUS "drone_controller: 0 messages, 2 services")
...
get_filename_component(_filename "/home/airbud/catkin_ws/src/drone_controller/srv/SetRefPose.srv" NAME_WE)
add_custom_target(_drone_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_controller" "/home/airbud/catkin_ws/src/drone_controller/srv/SetRefPose.srv" ""
)

get_filename_component(_filename "/home/airbud/catkin_ws/src/drone_controller/srv/MoveDroneW.srv" NAME_WE)
add_custom_target(_drone_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_controller" "/home/airbud/catkin_ws/src/drone_controller/srv/MoveDroneW.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone_controller\")")
  # install generated code
  install(
